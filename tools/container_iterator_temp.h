...
namespace IRT
{
  namespace Tools
  {
    ...
    class LinearIterator : public boost::mpl::if_<typename boost::is_const<typename boost::remove_reference<Container>::type>::type, std::iterator<std::random_access_iterator_tag, typename boost::add_const<typename Container::DataType>::type, ptrdiff_t, typename boost::add_const<typename Container::DataType>::type*, typename boost::add_const<typename Container::DataType>::type&>, std::iterator<std::random_access_iterator_tag, typename Container::DataType, ptrdiff_t, typename Container::DataType*, typename Container::DataType&> >::type
    {
      /// Type of the parent
    ...
    public:
      ...
      * @param pointer is a pointer in the data
